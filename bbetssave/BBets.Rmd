...
First, we're going to create a histogram of all the updated information from Blackboard and use code to show us the results.
...
Professor Brownlow did pretty well with his bets despite him losing a good amount.
...
According to Blackboard, the confidence interval is 90% which means there's 5% to the right and left to make up for the remaining 10%.

# Discussion and Conclusion

<!--Discussion and conclusion here.  If professor Brownlow is consistantly making or losing money how could he change his payout so that his profits center on zero?  Also discuss what size his class should be in order to have his current scheme balance at zero profit.!-->

If we change the class size to 28, it averages out to $0.
